            ...
            html: `
                ...
                <body>
                    <div class="email-container">
                        ...
                        <div class="content">
                            <h3>Hello!</h3>
                            <p>You recently requested to ${emailType === "VERIFY" ? "verify your email address" : "reset your password"} for your WebD.One account.</p>
                        ...
                        <div class="footer">
                            <p>&copy; ${new Date().getFullYear()} WebD.One. All rights reserved.</p>
                        </div>
                    </div>
                </body>
                </html>
