...
import StyleControls from '@/app/boltweb/Bolt/style/StyleControls';
import Gallery from '@/app/boltweb/Bolt/gallery/Gallery';
...
Happy coding! 🚀`;
  ...
  const handleGenerate = async () => {
    ...
    try {
      const response = await fetch(`/api/users/boltgen`, {
        method: "POST",
  ...
  const handleSendToCodeGeneration = async (imageId: string) => {
    ...
    try {
      ...
      const response = await fetch('/api/users/boltweb', {
        method: 'POST',
        body: formData,
      });
  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      const response = await fetch('/api/users/bolt-web', {
        method: 'POST',
        body: formData,
      });
